            ...
            <form id={form.id} onSubmit={form.onSubmit} action={action} noValidate>
                <CardContent className="flex flex-col gap-y-4">
                    <div className="flex flex-col gap-y-2">
                        ...
                        <Input name={fields.fullName.name} key={fields.fullName.key} defaultValue={fullName} placeholder="Enter Name"/>
                        <p className="text-red-500 text-sm">{fields.fullName.errors}</p>
                    </div>
                    <div className="flex flex-col gap-y-2">
                        <Label>Email</Label>
                        <Input disabled defaultValue={email} placeholder="test@.com"/>
                    </div>
                    ...
                    <div className="grid gap-y-5">
                        ...
                        {currentProfileImage?(
                            <div className="relative size-16">
                                ...
                                <Button onClick={handleDeleteImage} variant="destructive" type="button" size="icon" className="absolute -top-3 -right-3">
                                    <X className="size-4"/>
                                </Button>
                            </div> 
                        ):(
